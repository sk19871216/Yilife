 ...
 */
public class GetAppsDetailHandler extends InnovationHttpResponseHandler {
    @Override
    public void onInnovationSuccess(JsonElement value) {
        GetAppsDetailResponse oaLoginResponse = get(value.toString(), GetAppsDetailResponse.class);
        onresponseSuccess(oaLoginResponse);
//        onLoginSuccess(value.toString());
    ...
    public void onresponseSuccess(GetAppsDetailResponse response) {
