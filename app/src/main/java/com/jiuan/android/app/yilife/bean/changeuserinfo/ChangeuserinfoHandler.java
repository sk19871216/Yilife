 ...
 */
public class ChangeuserinfoHandler extends InnovationHttpResponseHandler {
    @Override
    public void onInnovationSuccess(JsonElement value) {
        ChangeuserinfoResponse oaLoginResponse = get(value.toString(), ChangeuserinfoResponse.class);
