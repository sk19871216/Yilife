 ...
 */
public class CheckPhoneCodeRequest extends InnovationRequestImpl {
    private static final String PATH_OA_LOGIN = "/api/verify_alter_phone_code";
    ...
    private class LoginRequestBody extends InnovationRequestBody{
        ...
        private LoginRequestBody() {
            setSc(ScAndSv.SC);
            setSv(ScAndSv.SV_53_verify_alter_phone_code);
        }
