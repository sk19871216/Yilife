 ...
 */
public class GetmynoteHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        GetmynoteResponse response = get(value.toString(),GetmynoteResponse.class);
...
//        }
    ...
    public void onLoginSuccess(GetmynoteResponse response) {
