 ...
 */
public class GetpinglunlistHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        GetpinglunlistResponse response = get(value.toString(),GetpinglunlistResponse.class);
