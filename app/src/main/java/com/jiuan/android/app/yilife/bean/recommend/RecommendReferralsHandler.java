 ...
 */
public class RecommendReferralsHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        RecommendReferralsResponse response = get(value.toString(),RecommendReferralsResponse.class);
