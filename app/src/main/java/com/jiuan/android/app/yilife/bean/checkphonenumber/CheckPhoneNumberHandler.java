 ...
 */
public class CheckPhoneNumberHandler extends InnovationHttpResponseHandler {

    @Override
    public void onInnovationSuccess(JsonElement value) {
        CheckPhoneNumberResponse oaLoginResponse = get(value.toString(), CheckPhoneNumberResponse.class);
    ...
    public void onLoginSuccess(CheckPhoneNumberResponse response) {
