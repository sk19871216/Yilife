 ...
 */
public class MyBBSNoteoldRequest extends InnovationRequestImpl {
    private static final String PATH_OA_LOGIN = "/bbs/get_myposts_older";
    ...
    private class LoginRequestBody extends InnovationRequestBody{
        ...
        private LoginRequestBody() {
            setSc(ScAndSv.SC);
            setSv(ScAndSv.SV_20_USER_OLDNOTE);
        }
