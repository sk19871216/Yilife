 ...
 */
public class GetForumuserinfoHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        GetForumuserinfoResponse oaLoginResponse = get(value.toString(), GetForumuserinfoResponse.class);
