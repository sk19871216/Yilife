 ...
 */
public class SendNoteHandler extends InnovationHttpResponseHandler {
    @Override
    public void onInnovationSuccess(JsonElement value) {
//        int oaLoginResponse = get(value.toString(), Integer.class);
        SendNoteResponse oaLoginResponse = get(value.toString(),SendNoteResponse.class);
