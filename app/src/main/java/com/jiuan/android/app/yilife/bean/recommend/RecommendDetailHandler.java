 ...
 */
public class RecommendDetailHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        RecommendDetailResponse response = get(value.toString(),RecommendDetailResponse.class);
