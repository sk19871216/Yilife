 ...
 */
public class ForgetPasswordChecknumberRequest extends InnovationRequestImpl {
    private static final String PATH_OA_LOGIN = "/api/verify_reset_code";
    ...
    private class LoginRequestBody extends InnovationRequestBody{
        ...
        private LoginRequestBody() {
            setSc(ScAndSv.SC);
            setSv(ScAndSv.SV_6_CHECKNUMBER_CHECK_AGAIN);
        }
