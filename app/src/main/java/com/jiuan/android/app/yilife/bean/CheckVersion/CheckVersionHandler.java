 ...
 */
public class CheckVersionHandler extends InnovationHttpResponseHandler {
    ...
    public void onInnovationSuccess(JsonElement value) {
        CheckVersionResponse oaLoginResponse = get(value.toString(), CheckVersionResponse.class);
