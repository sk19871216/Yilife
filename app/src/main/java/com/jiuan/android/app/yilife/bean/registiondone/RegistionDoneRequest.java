 ...
 */
public class RegistionDoneRequest extends InnovationRequestImpl {
    private static final String PATH_OA_LOGIN = "/api/reg_phone";
    ...
    private String password,invitationCode;
    ...
    private class LoginRequestBody extends InnovationRequestBody{
        ...
        private LoginRequestBody() {
            setSc(ScAndSv.SC);
            setSv(ScAndSv.SV_3_REGISTRATION_PHONE);
        }
