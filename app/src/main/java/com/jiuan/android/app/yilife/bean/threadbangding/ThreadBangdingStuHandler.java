 ...
 */
public class ThreadBangdingStuHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        ThreadBangdingStuResponse response = get(value.toString(),ThreadBangdingStuResponse.class);
