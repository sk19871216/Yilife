 ...
 */
public class ChangetouxiangPicRequest extends InnovationRequestImpl {
    private static final String PATH_OA_LOGIN = "/api/upload_avatars";
    ...
    private class LoginRequestBody extends InnovationRequestBody{
        ...
        private LoginRequestBody() {
            setSc(ScAndSv.SC);
            setSv(ScAndSv.SV_38_UPLOAD_AVATARS);
        }
