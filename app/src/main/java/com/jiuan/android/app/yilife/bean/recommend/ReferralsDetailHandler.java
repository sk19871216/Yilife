 ...
 */
public class ReferralsDetailHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        ReferralsDetailResponse response = get(value.toString(),ReferralsDetailResponse.class);
