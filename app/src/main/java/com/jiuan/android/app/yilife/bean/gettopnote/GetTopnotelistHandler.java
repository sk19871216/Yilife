 ...
 */
public class GetTopnotelistHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        GetTopnotelistResponse response = get(value.toString(),GetTopnotelistResponse.class);
