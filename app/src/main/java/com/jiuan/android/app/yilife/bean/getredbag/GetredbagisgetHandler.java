 ...
 */
public class GetredbagisgetHandler extends InnovationHttpResponseHandler {


    @Override
    public void onInnovationSuccess(JsonElement value) {
        GetredbagisgetResponse oaLoginResponse = get(value.toString(), GetredbagisgetResponse.class);
...
//        }
    ...
    public void onLoginSuccess(GetredbagisgetResponse response) {
